...
class EstatePropertyController(http.Controller):
    ...
    @http.route(['/estate/properties', '/estate/properties/page', '/estate/properties/page/<int:page>'], type='http', auth='public', website=True)
    ...
    @http.route('/estate/properties/page', type='http', auth='public', website=True)
